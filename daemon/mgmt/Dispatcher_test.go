...
func Test(t *testing.T) {
	...
	dispatcher.AddTopPrefix(topPrefix, fibManager.fib, faceServer)
	...
	dispatcher.AddTopPrefix(topPrefix, fibManager.fib, faceServer)
	fibManager.fib.AddOrUpdate(topPrefix, faceServer, 0)
	dispatcher.Start()
